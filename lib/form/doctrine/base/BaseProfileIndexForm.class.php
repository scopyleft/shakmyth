...
/**
 * ProfileIndex form base class.
 *
 * @method ProfileIndex getObject() Returns the current form's model object
 *
 * @package    shakmyth
 * @subpackage form
 ...
 */
abstract class BaseProfileIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('profile_index[%s]');
