...
/**
 * MythPageIndex form base class.
 *
 * @method MythPageIndex getObject() Returns the current form's model object
 *
 * @package    shakmyth
 * @subpackage form
 ...
 */
abstract class BaseMythPageIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('myth_page_index[%s]');
